...
export const resetPasswordMail = async (email: string, token: string) => {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f9f9f9; font-size: 13px;">
    ...
    <p style="color: #555; font-size: 13px;">Hello,</p>
    ...
    <div style="text-align: center; margin: 20px 0;">
      <a href="${resetUrl}" style="background-color: #007bff; color: #ffffff; padding: 10px 16px; text-decoration: none; font-weight: bold; border-radius: 5px; display: inline-block; font-size: 13px;">
        Reset Password
      </a>
    </div>
    ...
    <p style="word-wrap: break-word; color: #007bff; font-size: 12px;">
      <a href="${resetUrl}" style="color: #007bff; font-size: 12px;">${resetUrl}</a>
    </p>
